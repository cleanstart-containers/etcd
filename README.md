...
**Image Path**: `public.ecr.aws/your-alias/etcd`
...
```bash
docker pull public.ecr.aws/your-alias/etcd:etcd
```
```bash
docker pull public.ecr.aws/your-alias/etcd:container
```
```bash
docker pull public.ecr.aws/your-alias/etcd:enterprise
```
...
```bash
docker run -it --name etcd public.ecr.aws/your-alias/etcd:latest
```
...
docker run -d --name etcd-prod \
  ...
  public.ecr.aws/your-alias/etcd:latest
```

Volume Mount Mount local directory for persistent data

```bash
docker run -v /app:/app public.ecr.aws/your-alias/etcd:latest
```

Port Forwarding Run with custom port mappings

```bash
docker run -p 8080:8080 public.ecr.aws/your-alias/etcd:latest
```
